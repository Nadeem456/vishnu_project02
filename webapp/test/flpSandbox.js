		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SAP App Demo02",
									"targetURL": "#vishnuproject02-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"vishnuproject02-display": {
								"semanticObject": "vishnuproject02",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=vishnuproject02",
									"url": sap.ui.require.toUrl("vishnuproject02")
								}
							}
						}
					}
